      ...
      <Modal visible={showPasswordModal} transparent animationType="slide">
        <View style={{
          ...
          <View style={{
            ...
            {[ 
              { placeholder: "Actual", set: setCurrentPass, show: showCurrent, toggle: () => setShowCurrent(!showCurrent) },
              { placeholder: "Nueva", set: setNewPass, show: showNew, toggle: () => setShowNew(!showNew) },
              { placeholder: "Repetir nueva", set: setRepeatPass, show: showRepeat, toggle: () => setShowRepeat(!showRepeat) }
            ].map((field, i) => (
